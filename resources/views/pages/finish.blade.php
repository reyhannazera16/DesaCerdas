    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 mb-lg-0 mb-3">
                <div class="card p-3">
                    <div class="img-box">
                        <img src="{{ asset('app-assets/gopay.png') }}"  style="width:180px;" alt="">
                    </div>
                    <div class="number">
                        <label class="fw-bold" for="">**** **** **** 1060</label>
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                        <small><span class="fw-bold">Expiry date:</span><span>8/23</span></small>
                        <small><span class="fw-bold">Name:</span><span>Kemang-Payment</span></small>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-lg-0 mb-3">
                <div class="card p-3">
                    <div class="img-box">
                        <img src="{{ asset('app-assets/ovo.png') }}"  style="width:130px;"
                            alt="">
                    </div>
                    <div class="number">
            ...
            <div class="col-lg-4 mb-lg-0 mb-3">
                <div class="card p-3">
                    <div class="img-box">
                        <img src="{{ asset('app-assets/qris.png') }}" style="width:300px;"
                            alt="">
                    </div>
                    <div class="number">
          ...
          <ul class="order" style="margin-bottom: -2px; margin-top: 11px;">
            <h5>No. Order : <b>********9010</b></h5>
          </ul>

            <div class="col-12 mt-0">
                <div class="card p-3">
                    <p class="mb-0 fw-bold h4">Tentang Produk</p>
                </div>
            </div>
            <div class="col-12">
                <div class="card p-3">
                    <div class="card-body border p-0">
                        ...
                        <div class="collapse p-3 pt-0" id="collapseExample">
                            <div class="row">
                                <div class="col-8">
                                    <p class="h4 mb-0">Ringkasan</p>
                                    <p class="mb-0"><span class="fw-bold">Produk:</span><span class="c-green"> Risiris</span></p>
                                    <p class="mb-0"><span class="fw-bold">Harga:</span><span
                                            class="c-green"> Rp. 50.000 </span></p>
                                            <p class="mb-0"><span class="fw-bold">Promo:</span><span
                                                class="c-green"> Rp. -10.000 </span></p>
                                                <p class="mb-0"><span class="fw-bold">Total:</span><span
                                                    class="c-green"> Rp. 40.000 </span></p>
            ...
            <hr class="mb-4">
                          ...
                          <div class="text-center">
                            ...
                            <a href="#myModal" class="btn btn-primary btn-lg btn-block" data-toggle="modal">Selesai</a>
                        </div>
                            ...
                            <div class="modal-dialog modal-confirm">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title w-100">Sukses</h4>
                                    </div>
                                    <div class="modal-body">
                                        <p class="text-center">Pembayaran anda sedang di proses, terimakasih atas kepercayaan anda.</p>
                                    </div>
